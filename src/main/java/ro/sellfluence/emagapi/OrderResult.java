...
public record OrderResult(
     ...
     *
     * It will log some stuff and return a boolean, which is an equals approximation.
     *
     ...
     */
    public boolean findDifferencesX(OrderResult other) {
        ...
        if (is_storno != other.is_storno) {
            System.out.printf("Storno status changed from %b to %b%n", is_storno, other.is_storno);
            hasDifference = true;
        }
        ...
        if (products.length != other.products.length) {
            System.out.printf("%d product(s) added.%n", other.products.length - products.length);
            hasDifference = true;
        }
    ...
    public boolean findDifferences(OrderResult other) {
        ...
        if (!Objects.equals(customer, other.customer)) {
            System.out.printf("Customer changed from %s to %s%n", customer, other.customer);
            hasDifference = true;
        }
        ...
        if (!Objects.equals(refunded_amount, other.refunded_amount)) {
            System.out.printf("Refunded amount changed from %s to %s%n", refunded_amount, other.refunded_amount);
            hasDifference = true;
        }
        ...
        if (!Objects.equals(maximum_date_for_shipment, other.maximum_date_for_shipment)) {
            System.out.printf("Maximum date for shipment changed from %s to %s%n", maximum_date_for_shipment, other.maximum_date_for_shipment);
            hasDifference = true;
        }
        ...
        if (has_editable_products != other.has_editable_products) {
            System.out.printf("Has editable products changed from %s to %s%n", has_editable_products, other.has_editable_products);
            hasDifference = true;
        }
